                    ...
                    <a href="#" class="open_close" id="close_in"><i class="icon_set_1_icon-77"></i></a>
                     <ul>
                        ...
                        <li class="megamenu submenu">
                            <a href="javascript:void(0);" class="show-submenu">FIXED GROUP  <i class="icon-down-open-mini"></i>
                            </a>

                            <ul>
                                <li>
                                    <a href="{{'/uae-georgia'}}">UAE to Georgia</a>
                                </li>
                                <li>
                                    <a href="{{'/uae-armenia'}}">UAE to Armenia</a>
                                </li>
                                <li>
                                    <a href="{{'/uar-azrebaijan'}}">UAE to Azerbaijan</a>
                                </li>
                        ...
                        <li class="megamenu submenu">
                            <a href="javascript:void(0);" class="show-submenu-mega">GLOBAL VISA<i class="icon-down-open-mini"></i></a>
